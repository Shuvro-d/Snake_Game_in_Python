...
START_Y = 0
#                                  Remaining Bugs
#There are a lot of bugs. I solved as much as I can and the rests are beyond my capabilities
...
#will depend on players luck for now.
 
# if you make this larger, the game will go slower
DELAY = 0.1 
                 
def create_goal_and_obstacle(canvas,score): # the function creates the goal, life and obstacle
...
def game_over(canvas,score):  #Deletes all the object in the canvas and print score in a black background
...
def print_score(canvas,score):
    text=canvas.create_text(145, PRINT_X, 
        str(score),
        color="black", 
        font="Courier", 
        font_size=20)
...
def print_power(canvas,x):
    power=canvas.create_text(145, PRINT_Y, 
        str(x),
        color="black", 
        font="Courier", 
        font_size=20)
...
def start_game(canvas):
    ...
    snake_x = START_X
    snake_y = START_Y
    score=0    #score and power is initially zero
    power=0
    ...
    canvas.create_text(10,PRINT_X , 
        "Score is =  ",
        color="black", 
        font="Courier", 
        font_size=20)
    canvas.create_text(10,PRINT_Y , 
        "Power is =  ",
        color="black", 
        font="Courier", 
        font_size=20)
    ...
    while True:
        ...
        if flag2==False:   # this make sure after reviving the snake doesn't take goal as obstacle. I put this because I am 
            goal,obstacle,life=create_goal_and_obstacle(canvas,score)# unable to figure out how to solve this issue
